...
__global__ void volume_transposeAddAvgVolume_kernel(
                    unsigned char* volumeT, int volumeT_s, int volumeT_p,
...
__global__ void volume_updateMinXSlice_kernel(
...
__global__ void volume_agregateCostVolumeAtZ_kernel(
                    unsigned char* volume, int volume_s, int volume_p,
                    unsigned char* xsliceBestInColCst, int volDimX, int volDimY,
...
__global__ void update_GC_volumeXYSliceAtZInt4_kernel(
                    int4* xySlice, int xySlice_p, unsigned int* volume, int volume_s,
                    int volume_p, int volDimX, int volDimY, int volDimZ, int vz);

////////////////////////////////////////////////////////////////////////////////////////////////////////////////////

__global__ void volume_GC_K_getVolumeXYSliceInt4ToUintDimZ_kernel(
                    unsigned int* oxySlice, int oxySlice_p,
                    int4* ixySlice, int ixySlice_p, int volDimX,
                    int volDimY);

__global__ void volume_GC_K_initXYSliceInt4_kernel(
                    int4* xySlice, int xySlice_p, unsigned int* volume, int volume_s,
                    int volume_p, int volDimX, int volDimY, int vz);

__global__ void update_GC_K_volumeXYSliceAtZInt4_kernel(
                    int4* xySlice, int xySlice_p, unsigned int* volume,
                    int volume_s, int volume_p, int volDimX, int volDimY,
                    int volDimZ, int vz, int K);

////////////////////////////////////////////////////////////////////////////////////////////////////////////////////

__global__ void volume_compute_rDP1_kernel(
                    int2* xySlice, int xySlice_p, int* ovolume, int ovolume_s, int ovolume_p,
                    unsigned int* volume, int volume_s, int volume_p, int volDimX, int volDimY,
                    int volDimZ, int vz);

__global__ void volume_compute_DP1_kernel(
                    int2* xySlice, int xySlice_p, int* ovolume, int ovolume_s, int ovolume_p,
                    unsigned int* volume, int volume_s, int volume_p, int volDimX, int volDimY,
                    int volDimZ, int vz);

__global__ void volume_compute_rDP1_volume_minMaxMap_kernel(
                    int2* xySlice, int xySlice_p, int* volume, int volume_s,
                    int volume_p, int volDimX, int volDimY, int volDimZ, int z,
                    int zPart, int volDimZGlob);

__global__ void volume_normalize_rDP1_volume_by_minMaxMap_kernel(
                    int2* xySlice, int xySlice_p, int* volume,
                    int volume_s, int volume_p, int volDimX, int volDimY,
...
__global__ void volume_filter_VisTVolume_kernel(
                    unsigned int* ovolume, int ovolume_s, int ovolume_p, int volDimX,
